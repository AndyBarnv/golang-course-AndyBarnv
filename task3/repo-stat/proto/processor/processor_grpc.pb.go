...
const (
	ProcessorService_GetRepositoryInfo_FullMethodName = "/processor.ProcessorService/GetRepositoryInfo"
...
type ProcessorServiceClient interface {
	GetRepositoryInfo(ctx context.Context, in *RepositoryRequest, opts ...grpc.CallOption) (*RepositoryResponse, error)
...
func (c *processorServiceClient) GetRepositoryInfo(ctx context.Context, in *RepositoryRequest, opts ...grpc.CallOption) (*RepositoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RepositoryResponse)
	err := c.cc.Invoke(ctx, ProcessorService_GetRepositoryInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProcessorServiceServer interface {
	GetRepositoryInfo(context.Context, *RepositoryRequest) (*RepositoryResponse, error)
...
func (UnimplementedProcessorServiceServer) GetRepositoryInfo(context.Context, *RepositoryRequest) (*RepositoryResponse, error) {
...
func _ProcessorService_GetRepositoryInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RepositoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProcessorServiceServer).GetRepositoryInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProcessorService_GetRepositoryInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProcessorServiceServer).GetRepositoryInfo(ctx, req.(*RepositoryRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ProcessorService_GetRepositoryInfo_Handler,
		},
		{
			MethodName: "Ping",

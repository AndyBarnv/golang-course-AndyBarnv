...
const file_proto_repository_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\tR\tcreatedAt2O\n" +
	"\vRepoService\x12@\n" +
	"\vGetRepoInfo\x12\x17.repository.RepoRequest\x1a\x18.repository.RepoResponseB\x06Z\x04./pbb\x06proto3"
...
var file_proto_repository_proto_depIdxs = []int32{
	0, // 0: repository.RepoService.GetRepoInfo:input_type -> repository.RepoRequest
	1, // 1: repository.RepoService.GetRepoInfo:output_type -> repository.RepoResponse

...
const (
	CollectorService_GetRepositoryInfo_FullMethodName = "/repository.CollectorService/GetRepositoryInfo"
)
...
func (c *collectorServiceClient) GetRepositoryInfo(ctx context.Context, in *RepositoryRequest, opts ...grpc.CallOption) (*RepositoryResponse, error) {
...
func (UnimplementedCollectorServiceServer) GetRepositoryInfo(context.Context, *RepositoryRequest) (*RepositoryResponse, error) {
...
func _CollectorService_GetRepositoryInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).GetRepositoryInfo(ctx, req.(*RepositoryRequest))
	}
